      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        >
          ...
          <p className="text-gray-600 dark:text-gray-300 font-inter">
            Marka işbirliklerini takip et ve yönet
          </p>
        </motion.div>
                ...
                <>
                    ...
                    <div className="flex items-start justify-between mb-4">
                      <div>
                        ...
                        <p className="text-white/80 font-inter">
                          {selectedCollaboration.brand_name}
                        </p>
                      </div>
                  ...
                  <div className="p-6 space-y-6">
                    ...
                    <div className="flex flex-col sm:flex-row gap-3 pt-4 border-t border-gray-200 dark:border-slate-700">
                      <Link
                        href={`/dashboard/messages?userId=${selectedCollaboration.brand_id}&name=${encodeURIComponent(selectedCollaboration.brand_name)}`}
