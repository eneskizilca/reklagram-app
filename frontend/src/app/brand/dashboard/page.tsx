      ...
      <header className="bg-white shadow-md">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4 flex justify-between items-center">
          <div className="flex items-center space-x-4">
            <h1 className="text-2xl font-bold text-blue-600">ReklaGram</h1>
            <span className="text-sm text-gray-500">Marka Panel</span>
          </div>
          <div className="flex items-center space-x-4">
        ...
        <div className="bg-white rounded-2xl shadow-xl p-8">
          <div className="text-center">
            ...
            <p className="text-gray-600 mb-8">
              ReklaGram Marka Dashboard'a hoş geldiniz
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mt-8">
            <div className="bg-blue-50 p-6 rounded-xl border border-blue-200">
              ...
              <h3 className="text-lg font-semibold text-gray-900">Influencer Ara</h3>
              <p className="text-gray-600 text-sm mt-2">
                Size uygun influencer'ları keşfedin
              </p>
            </div>
